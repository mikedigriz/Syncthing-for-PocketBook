...
Версия Syncthing v1.27.12, Linux (32-bit ARM)<br>
...
- Скачать версию [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v1.27.12/syncthing-linux-arm-v1.27.12.tar.gz)
