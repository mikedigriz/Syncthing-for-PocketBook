...
Версия Syncthing v1.27.5, Linux (32-bit ARM)
...
- Скачать версию [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v1.27.5/syncthing-linux-arm-v1.27.5.tar.gz)
