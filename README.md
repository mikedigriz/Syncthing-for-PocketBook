...
Версия ПО 6.8.3455<br>
Версия Syncthing v1.27.8, Linux (32-bit ARM)
...
- Скачать версию [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v1.27.8/syncthing-linux-arm-v1.27.8.tar.gz)
