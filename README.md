...
Версия Syncthing 2.0.10, Linux (32-bit ARM)<br>
Также работает на:
\
...
- Скачать версию [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v2.0.10/syncthing-linux-arm-v2.0.10.tar.gz)
