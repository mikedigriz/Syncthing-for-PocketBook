...
Syncthing 2.1.1, Linux version (32-bit ARM)<br>
Also works on:
\
...
- Download version [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v2.1.1/syncthing-linux-arm-v2.1.1.tar.gz)

- Extract to created folder `ext1\applications\syncthing\` binary file - *syncthing* (24mb size)
