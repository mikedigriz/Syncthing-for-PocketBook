...
Syncthing v1.29.2, Linux version (32-bit ARM)<br>
...
- Download version [Linux 32-bit ARM](https://github.com/syncthing/syncthing/releases/download/v1.29.2/syncthing-linux-arm-v1.29.2.tar.gz)
